...
@Composable
fun rememberRequestMultiplePermissions(
    ...
    return remember(permissions.contentHashCode()) {
        {
...
fun rememberNavigateToAppSettings(): () -> Unit {
    val context = LocalContext.current
    val appSettingsContract = rememberLauncherForActivityResult(
...
fun rememberNavigateToDeveloperSettings(): () -> Unit {
    ...
    return remember { {
        appSettingsContract.launch(Intent(Settings.ACTION_APPLICATION_DEVELOPMENT_SETTINGS))
    } }
}
