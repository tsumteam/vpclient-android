...
object ClientTypography {
    ...
    val Regular_11: TextStyle
        get() = Regular.copy(fontSize = 11.sp)
    ...
    val Regular_12_Error: TextStyle
        @Composable get() = Regular_12.copy(color = MaterialTheme.colorScheme.error)
    ...
    val Regular_15_OnBackground: TextStyle
        @Composable get() = Regular_15.copy(color = MaterialTheme.colorScheme.onBackground)
    ...
    private val Medium_21: TextStyle
        get() = Medium.copy(fontSize = 21.sp)

    val Medium_21_OnBackground: TextStyle
        @Composable get() = Medium_21.copy(color = MaterialTheme.colorScheme.onBackground)
