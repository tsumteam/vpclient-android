...
import ru.mercury.vpclient.shared.domain.mapper.withCompilationImage
...
data class NotificationsModel(
    ...
    val displayedNotificationEntities: List<ClientNotificationEntity>
        get() = notificationEntities.map { entity -> entity.withCompilationImage(compilationEntities) }
