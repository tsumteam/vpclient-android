...
fun CartFittingEditProductSheet(
    ...
    SharedModalBottomSheet(
        ...
        CartFittingEditProductSheetContent(
...
@Composable
private fun CartFittingEditProductSheetContent(
    dispatch: (CartFittingEditProductSheetIntent) -> Unit
) {
    SharedLazyColumn(
        ...
        item {
            Button(
                onClick = { dispatch(CartFittingEditProductSheetIntent.ChangeColorClick) },
                modifier = Modifier
                    .fillMaxWidth()
                    .height(58.dp),
        ...
        item {
            Button(
                onClick = { dispatch(CartFittingEditProductSheetIntent.ChangeSizeClick) },
                modifier = Modifier
                    .fillMaxWidth()
                    .height(58.dp),
        ...
        item {
            Button(
                onClick = { dispatch(CartFittingEditProductSheetIntent.ConfirmClick) },
                modifier = Modifier
                    .fillMaxWidth()
                    .height(52.dp),
...
@Preview
@Composable
private fun CartFittingEditProductSheetContentPreview() {
    CartFittingEditProductSheetContent(
        dispatch = {}
    )
}
