...
sealed interface FittingAddressIntent: Intent {
    data object DismissClick: FittingAddressIntent
    data object OpenAddressSearch: FittingAddressIntent
    data object SaveAddressClick: FittingAddressIntent
    data class AddressFormValueChange(val field: FittingAddressFormField, val value: String): FittingAddressIntent
}
