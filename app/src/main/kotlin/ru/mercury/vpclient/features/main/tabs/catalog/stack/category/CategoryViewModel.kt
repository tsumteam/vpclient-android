...
class CategoryViewModel @AssistedInject constructor(
    ...
    override fun dispatch(intent: CategoryIntent) {
        when (intent) {
            ...
            is CategoryIntent.FilterClick -> launch { CatalogStackEventManager.send(FilterRoute(categoryId = intent.categoryId, titleCategoryId = intent.titleCategoryId, subtitleCategoryId = intent.subtitleCategoryId)) }
        }
    }
