...
val VipPlatinumClient: ImageVector
    get() {
        if (_vipPlatinumClient != null) {
            return _vipPlatinumClient!!
        }
        _vipPlatinumClient = ImageVector.Builder(
            name = "VipPlatinumClient",
            defaultWidth = 175.dp,
            defaultHeight = 92.dp,
            viewportWidth = 175F,
            viewportHeight = 92F
            ...
            addPath(
                pathData = addPathNodes(
                    "M82.2588 56.0005L96.2072 73.4336H104.589V60.0001L82.2588 56.0005Z"
                ),
            ...
            addPath(
                pathData = addPathNodes(
                    """
                    M83.2503 41.7502C86.9898 41.7502 90.0212 38.7188 90.0212 34.9793C90.0212 31.2399 86.9898 28.2085 83.2503 28.2085C79.5109 28.2085 76.4795 31.2399 76.4795 34.9793C76.4795 38.7188 79.5109 41.7502 83.2503 41.7502Z
                    """.trimIndent()
                ),
            ...
            addPath(
                pathData = addPathNodes(
                    "M94.8827 55.2917C94.8827 50.051 89.6692 45.8125 83.2505 45.8125C76.8317 45.8125 71.6182 50.051 71.6182 55.2917"
                ),
                fill = SolidColor(Color(0x00000000)),
                pathFillType = PathFillType.NonZero,
                stroke = SolidColor(Color(0xFFDFDDE8)),
...
private var _vipPlatinumClient: ImageVector? = null

@PreviewWrapper(ThemeWrapper::class)
@Preview(showBackground = true)
@Composable
private fun VipPlatinumClientPreview() {
    Icon(
        imageVector = VipPlatinumClient,
