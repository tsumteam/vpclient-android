...
import ru.mercury.vpclient.shared.data.network.response.CompilationLookPayloadResponse
import ru.mercury.vpclient.shared.data.network.type.MessageType

@Serializable
data class SaveCompilationLookMessageRequest(
    ...
    @SerialName("payload") val payload: CompilationLookPayloadResponse? = null,
