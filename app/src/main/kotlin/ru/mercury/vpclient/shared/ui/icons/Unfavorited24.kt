...
val Unfavorited24: ImageVector
    get() {
        if (_unfavorited24 != null) {
            return _unfavorited24!!
        }
        _unfavorited24 = ImageVector.Builder(
            name = "Unfavorited24",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24F,
...
private var _unfavorited24: ImageVector? = null

@PreviewWrapper(ThemeWrapper::class)
@Preview(showBackground = true)
@Composable
private fun Unfavorited24Preview() {
    Icon(
        imageVector = Unfavorited24,
