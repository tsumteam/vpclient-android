...
@Serializable
data class FilterIdTreeValueResponse(
    ...
    @SerialName("children") val children: List<FilterIdTreeValueResponse>? = null,
    @SerialName("isLeafNode") val isLeafNode: Boolean? = null,
