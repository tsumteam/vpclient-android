...
val Typography.livretRegular13: TextStyle
    get() = TextStyle(
        fontWeight = FontWeight.W400,
        fontFamily = FontFamily(Font(resId = R.font.tt_livret_subhead_regular, weight = FontWeight.W400)),
        fontSize = 13.sp
...
val Typography.livretMedium10: TextStyle
    get() = TextStyle(
...
val Typography.livretMedium15: TextStyle
    get() = TextStyle(
        fontWeight = FontWeight.W500,
        fontFamily = FontFamily(Font(resId = R.font.tt_livret_subhead_medium, weight = FontWeight.W500)),
        fontSize = 15.sp
...
val Typography.livretMedium17: TextStyle
    get() = TextStyle(
        fontWeight = FontWeight.W500,
        fontFamily = FontFamily(Font(resId = R.font.tt_livret_subhead_medium, weight = FontWeight.W500)),
        fontSize = 17.sp
