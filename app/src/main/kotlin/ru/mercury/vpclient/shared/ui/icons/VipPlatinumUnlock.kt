...
val VipPlatinumUnlock: ImageVector
    get() {
        if (_vipPlatinumUnlock != null) {
            return _vipPlatinumUnlock!!
        }
        _vipPlatinumUnlock = ImageVector.Builder(
            name = "VipPlatinumUnlock",
            defaultWidth = 175.dp,
            defaultHeight = 92.dp,
            viewportWidth = 175F,
            viewportHeight = 92F
            ...
            addPath(
                pathData = addPathNodes(
                    """
                    M76.4178 40V31.7725C76.4178 25.9491 81.3899 21.2111 87.5 21.2111C93.6101 21.2111 98.5822 25.9491 98.5822 31.7725V34H103V31.7725C103 23.628 96.047 17 87.5 17C78.953 17 72 23.628 72 31.7725V40H76.4178Z
                    """.trimIndent()
                ),
...
private var _vipPlatinumUnlock: ImageVector? = null

@PreviewWrapper(ThemeWrapper::class)
@Preview(showBackground = true)
@Composable
private fun VipPlatinumUnlockPreview() {
    Icon(
        imageVector = VipPlatinumUnlock,
