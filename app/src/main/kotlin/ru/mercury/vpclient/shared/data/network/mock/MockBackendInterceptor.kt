...
class MockBackendInterceptor(
    ...
    private companion object {
        ...
        const val ACTIVITY_COUNTERS_RESPONSE = """{"data":{"items":[{"type":"messages","value":7},{"type":"basket","value":2},{"type":"fitting","value":1},{"type":"compilation","value":3}]},"error":null,"errors":null,"type":null,"title":null,"status":200,"traceId":null}"""
