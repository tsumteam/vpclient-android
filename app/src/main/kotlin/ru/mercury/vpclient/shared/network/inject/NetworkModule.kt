package ru.mercury.vpclient.shared.network.inject
...
import ru.mercury.vpclient.shared.APP_FULL_VERSION
import ru.mercury.vpclient.shared.APP_VERSION
import ru.mercury.vpclient.shared.DEFAULT_EMPLOYEE_APP
import ru.mercury.vpclient.shared.ktx.orEmpty
import ru.mercury.vpclient.shared.ktx.versionCode
    ...
    fun provideKtorHttpClient(
        ...
        val ktor = HttpClient(OkHttp) {
            defaultRequest {
                ...
                val clientEnvironment = resolveEnvironment(clientEnvironmentName)
