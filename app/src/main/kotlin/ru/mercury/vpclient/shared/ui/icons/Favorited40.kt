...
val Favorited40: ImageVector
    get() {
        if (_favorited40 != null) {
            return _favorited40!!
        }
        _favorited40 = ImageVector.Builder(
            name = "Favorited40",
            defaultWidth = 40.dp,
            defaultHeight = 40.dp,
            viewportWidth = 40F,
...
private var _favorited40: ImageVector? = null

@FontScalePreviews
@Composable
private fun Favorited40Preview() {
    ClientTheme {
        Icon(
