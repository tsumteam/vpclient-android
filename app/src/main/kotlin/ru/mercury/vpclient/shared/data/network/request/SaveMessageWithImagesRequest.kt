...
import ru.mercury.vpclient.shared.data.network.response.ImagesPayloadResponse
import ru.mercury.vpclient.shared.data.network.type.MessageType

@Serializable
data class SaveMessageWithImagesRequest(
    ...
    @SerialName("payload") val payload: ImagesPayloadResponse? = null,
