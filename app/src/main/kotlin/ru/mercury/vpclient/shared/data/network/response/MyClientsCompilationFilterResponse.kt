...
import ru.mercury.vpclient.shared.data.network.type.MyClientsFilterType

@Serializable
data class MyClientsCompilationFilterResponse(
    @SerialName("filterType") val filterType: MyClientsFilterType? = null,
