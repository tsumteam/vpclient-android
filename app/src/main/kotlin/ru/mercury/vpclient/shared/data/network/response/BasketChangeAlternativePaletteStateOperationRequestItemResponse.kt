...
@Serializable
data class BasketChangeAlternativePaletteStateOperationRequestItemResponse(
    ...
    @SerialName("paletteState") val paletteState: BasketAlternativesPaletteState? = null
)
